...
df = pd.read_csv('/home/jason_tang/datasci_9_data_prep/Data/processed/monkey_processed.csv')
len(df)
...
X = df.drop('agency_and_office_name', axis=1)  # Features (all columns except 'arrest')
y = df['agency_and_office_name']               # Target variable (arrest)

# Initialize the StandardScaler
scaler = StandardScaler()
scaler.fit(X) # Fit the scaler to the features
pickle.dump(scaler, open('/home/jason_tang/datasci_9_data_prep/Data/models/scaler_100k.sav', 'wb')) # Save the scaler for later use
